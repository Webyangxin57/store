...
<html>
	...
	<%@ include file="./header.jsp" %>
		...
		<form action="${pageContext.request.contextPath}/OrderServlet?method=payOrder" method="post" id="orderForm">
		<div class="container">
			<div class="row">
			...
			<div>
				<hr/>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="telephone" name="telephone" class="form-control" id="confirmpwd" placeholder="请输入联系方式">
						</div>
